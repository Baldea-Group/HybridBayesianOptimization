# Multi-Scale Bayesian Optimization (Python)
...
This code extends the MATLAB implementation in [`../matlab/`](../matlab/) to a 13-problem benchmark suite. For the original CSTR case study and published paper, see [Baldea (2026)](https://doi.org/10.1002/aic.70228).
